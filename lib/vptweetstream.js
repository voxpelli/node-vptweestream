...
createStream = function (oauth, stream) {
  var currentRequest, newRequest, twitterEvents, closed, // Vars
    changeStream, closeStream, parseStreamUpdate, handleStream; // Functions
      ...
      theRequest = newRequest = request({
        ...
        response.on('end', function () {
          ...
          if (theRequest === newRequest) {
            ...
            console.log('Twitter stream closed down.');
          } else {
